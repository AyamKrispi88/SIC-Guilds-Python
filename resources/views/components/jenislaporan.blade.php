...
<div class="dropdown-statuslaporan-wrapper relative">
    ...
    <input type="hidden" name="jenis_laporan" id="jenis_laporan_input" value="">
    ...
    <div class="dropdown-statuslaporan-menu hidden origin-top-right absolute right-0 mt-2 w-full rounded-md shadow-lg bg-white ring-1 ring-white ring-opacity-5 focus:outline-none z-10">
        <div role="menu" aria-orientation="vertical" aria-labelledby="options-menu">
            <p class="statuslaporan-item block px-4 py-2 text-sm text-white hover:bg-blue-600 border border-white rounded bg-blue-800" role="menuitem" data-value="Kasus Kriminal">Laporan Kriminal</p>
            
            <p class="statuslaporan-item block px-4 py-2 text-sm text-white hover:bg-blue-600 border border-white rounded bg-blue-800" role="menuitem" data-value="Kepadatan Lalu Lintas">Hambatan Lalu Lintas</p>
            
            <p class="statuslaporan-item block px-4 py-2 text-sm text-white hover:bg-blue-600 border border-white rounded bg-blue-800" role="menuitem" data-value="Orang Hilang">Laporan Orang Hilang</p>
        </div>
    </div>
</div>
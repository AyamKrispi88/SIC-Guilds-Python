...
<div class="p-5">
    ...
    <div class="grid grid-cols-1 gap-6 mb-8 w-full max-w-2xl">  
        ...
        <div class="w-full">
            ...
            <div class="relative">
                <input type="text" value="Patung macan"  class="w-full p-3 md:p-4 pr-12 border border-gray-300 rounded-md shadow-sm focus:outline-none">
                <div class="absolute inset-y-0 right-4 flex items-center pointer-events-none">
        ...
        <div class="flex flex-col md:flex-row gap-5 justify-between items-start">
            <div class="grid grid-cols-1 gap-6 mb-8 w-full max-w-[610px]">
                <div class="w-full">
                    ...
                    <input type="text" value="Krishna Ardi si Merah dari goa hitam"  class="w-full p-3 md:p-4 pr-12 border border-gray-300 rounded-md shadow-sm focus:outline-none">
                </div>
                <div class="w-full">
                    <h4 class="text-md md:text-lg font-semibold mb-2">Jenis Kelamin</h4>
                    <input type="text" value="Laki - laki"  class="w-full p-3 md:p-4 pr-12 border border-gray-300 rounded-md shadow-sm focus:outline-none">
                </div>
                <div class="w-full">
                    <h4 class="text-md md:text-lg font-semibold mb-2">Kewarganegaraan</h4>
                    <input type="text" value="WNI/Warga Negara Indonesia"  class="w-full p-3 md:p-4 pr-12 border border-gray-300 rounded-md shadow-sm focus:outline-none">
                </div>
                <div class="w-full">
                    <h4 class="text-md md:text-lg font-semibold mb-2">Tanggal Lahir</h4>
                    <input type="text" value="29 Februari 2990"  class="w-full p-3 md:p-4 pr-12 border border-gray-300 rounded-md shadow-sm focus:outline-none">
                </div>  
            </div> </div> </div> 
    <div class="w-full max-w-[610px]"> 
        <div class="w-full">
            <h4 class="text-md md:text-lg font-semibold mb-2">Tinggi Badan</h4>
            <input type="text" value="173 cm"  class="w-full p-3 md:p-4 pr-12 border border-gray-300 rounded-md shadow-sm focus:outline-none">
        </div>
        <div class="w-full mt-6"> 
            <h4 class="text-md md:text-lg font-semibold mb-2">Berat Badan</h4>
            <input type="text" value="70 kg"  class="w-full p-3 md:p-4 pr-12 border border-gray-300 rounded-md shadow-sm focus:outline-none">
        </div>
    </div>
</div> 
...
<div class="w-full px-5 pt-5 md:pt-0">
            ...
            <div class="relative">
                <textarea type="text" placeholder="Tuliskan keterangan lengkap orang yang hilang" class="w-full p-3 md:p-4 pr-12 border border-gray-300 rounded-md shadow-sm focus:outline-none mb-10 h-[140px]">
Ya begitulah
                </textarea>
            </div>
        </div>

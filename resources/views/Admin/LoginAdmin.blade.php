...
<div class="mt-10 px-4">
    ...
    @if ($errors->any())
        <div class="w-[90%] md:w-full max-w-md mx-auto mb-4">
    ...
    <form method="POST" action="{{ route('login.admin.store') }}">
        ...
        <div class="w-[90%] md:w-full max-w-md mx-auto">
            <button type="submit" class="w-full bg-blue-500 hover:bg-blue-700 flex justify-center mt-6 md:mt-10 py-3 md:py-4 font-bold text-white rounded-md">
                Login
            </button>
        </div>
